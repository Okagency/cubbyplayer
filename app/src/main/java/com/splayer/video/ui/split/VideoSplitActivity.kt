...
class VideoSplitActivity : AppCompatActivity() {
    ...
    private fun updateFromToDisplay() {
        ...
        txtFromToInfo.text = "시작: $fromStr  →  끝: $toStr"
        btnFrom.text = if (fromTimeMs >= 0) "시작 ✓" else "시작"
        btnTo.text = if (toTimeMs >= 0) "끝 ✓" else "끝"
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("확인") { _, _ ->
                ...
                if (newTo > newFrom) {
                    ...
                    Toast.makeText(this, "끝 시간은 시작보다 커야 합니다.", Toast.LENGTH_SHORT).show()
                }
            }
